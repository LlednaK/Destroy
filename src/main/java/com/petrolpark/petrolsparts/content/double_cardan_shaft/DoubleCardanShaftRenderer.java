...
public class DoubleCardanShaftRenderer extends KineticBlockEntityRenderer<DoubleCardanShaftBlockEntity> {
    ...
    protected void renderSafe(DoubleCardanShaftBlockEntity doubleCardanShaftBlockEntity, float partialTicks, PoseStack ms, MultiBufferSource buffer, int light, int overlay) {
        ...
        CachedBuffers.partialFacing(PetrolsPartsPartialModels.DCS_GIMBAL, state, shaft1Direction)
            ...
            .rotate(DoubleCardanShaftVisual.gimbalRotation(shaft1Direction, axis == Axis.Z), gimbal1FluctuatingAngle)
            .rotateYDegrees(axis == Axis.Z && !secondaryPositive ? 90 : 0)
            .rotateXDegrees(axis == Axis.Z ? 90 : 0)
            .translate(DoubleCardanShaftVisual.gimbalTranslation(shaft1Direction))
